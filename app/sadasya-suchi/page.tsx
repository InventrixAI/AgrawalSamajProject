...
export default function SadasyaSuchiPage() {
    ...
    <div className="min-h-screen py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">समाज सूची</h1>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            हमारे सदस्य सूची पीडीएफ दस्तावेज़ यहां देखें।
          </p>
        </div>
        ...
        <section className="mb-16">
          <Card>
            <CardHeader>
              <CardTitle>Sadasya Suchi Documents</CardTitle>
              <CardDescription>Our collection of Sadasya Suchi documents.</CardDescription>
            </CardHeader>
            <CardContent>
              {loading ? (
                ...
                <div className="text-center py-4 text-gray-500">
                  No Sadasya Suchi PDFs available yet.
                </div>
              ) : (
