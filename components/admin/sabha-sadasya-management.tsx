...
export default function SabhaSadasyaManagement() {
  ...
  const handleFileUpload = async () => {
    ...
    try {
      ...
      // Now save the PDF URL and title to your sabha_sadasya table
      const saveResponse = await fetch("/api/admin/sabha-sadasya", {
        method: "POST",
      ...
      <Card>
        <CardHeader>
          <div className="flex justify-between items-center">
            <div>
              <CardTitle>Sabha Sadasya Management</CardTitle>
              <CardDescription>Manage Sabha Sadasya PDF documents</CardDescription>
            </div>
            <Dialog open={addPdfDialogOpen} onOpenChange={setAddPdfDialogOpen}>
              ...
              <DialogContent>
                <DialogHeader>
                  <DialogTitle>Upload New Sabha Sadasya PDF</DialogTitle>
                </DialogHeader>
                ...
                <DialogFooter>
                  <Button variant="outline" onClick={() => setAddPdfDialogOpen(false)}>Cancel</Button>
        ...
        <CardContent>
          ...
          {loading ? (
            ...
            <p className="text-sm text-gray-500">No Sabha Sadasya PDFs uploaded yet. Use the "Add New PDF" button above.</p>
          ) : (
